...
export function isWritingPage(path: string) {
  return matchPageType(path, 'writing')
}

export function isCollectionPage(path: string) {
  return matchPageType(path, 'collections')
}

export function isPhotoPage(path: string) {
  return matchPageType(path, 'photos')
}
...
export function getPageInfo(path: string) {
  ...
  const isWriting = isWritingPage(path)
  const isCollection = isCollectionPage(path)
  const isPhoto = isPhotoPage(path)
